...
export function LegalModal() {
  return (
    <Dialog>
      <DialogTrigger className="text-sm font-light  hover:underline transition-all">Mentions Légales</DialogTrigger>

      <DialogContent className="min-w-1/3 h-[90vh] p-4 overflow-hidden bg-white ring-0 shadow-2xl">
        <DialogHeader>
          <DialogTitle className="font-dm-serif text-2xl text-center text-palmier border-b pb-4">
            Mentions Légales
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto pr-2 mt-4">
          <div
            className="prose prose-sm md:prose-base max-w-none text-left font-montserrat text-dark-800
